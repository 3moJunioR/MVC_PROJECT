...
namespace finalProj.Migrations
{
    ...
    [Migration("20260321171518_AddImageUrlToProduct")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("finalProj.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("finalProj.Models.Address", b =>
                {
                    b.HasOne("finalProj.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("finalProj.Models.Category", b =>
                {
                    b.HasOne("finalProj.Models.Category", "ParentCategory")
                        .WithMany()
            ...
            modelBuilder.Entity("finalProj.Models.Order", b =>
                {
                    b.HasOne("finalProj.Models.Address", "ShippingAddress")
                        .WithMany()
